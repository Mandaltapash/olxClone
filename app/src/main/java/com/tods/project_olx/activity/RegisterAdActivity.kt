...
class RegisterAddActivity : AppCompatActivity() {
    ...
    private fun requestPermission(){
        when {
            ...
            ActivityCompat.shouldShowRequestPermissionRationale(this, android.Manifest.permission.READ_EXTERNAL_STORAGE) -> {
                ActivityCompat.requestPermissions(this, arrayOf(android.Manifest.permission.READ_EXTERNAL_STORAGE), SELECTION_GALLERY_AD1)
            }
            else -> {
    ...
    private fun configSpinners(){
        ...
        val adapterStates: ArrayAdapter<String> = ArrayAdapter(this, android.R.layout.simple_spinner_item, states)
